"""
Django settings for projetDatascience project.
...
SECRET_KEY = 'django-insecure-3!qk55+5wq+!tbnz8*+)m+v+l!u&^b=xuxug_6bmmw@_ra%h4+'
...
ROOT_URLCONF = 'projetDatascience.urls'
...
WSGI_APPLICATION = 'projetDatascience.wsgi.application'
